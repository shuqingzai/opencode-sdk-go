...
type V2Event struct {
	...
	// This field can have the runtime type of one of the [V2EventPayloadUnion]
	// variants' Data sub-structs:
	// [V2EventCatalogUpdatedData],
	// [V2EventCommandExecutedData],
	// [V2EventFileEditedData],
	// [V2EventFileWatcherUpdatedData],
	// [V2EventGlobalDisposedData],
	// [V2EventInstallationUpdateAvailableData],
	// [V2EventInstallationUpdatedData],
	// [V2EventIntegrationConnectionUpdatedData],
	// [V2EventIntegrationUpdatedData],
	// [V2EventLspUpdatedData],
	// [V2EventMcpBrowserOpenFailedData],
	// [V2EventMcpToolsChangedData],
	// [V2EventMessagePartDeltaData],
	// [V2EventMessagePartRemovedData],
	// [V2EventMessagePartUpdatedData],
	// [V2EventMessageRemovedData],
	// [V2EventMessageUpdatedData],
	// [V2EventModelsDevRefreshedData],
	// [V2EventPermissionAskedData],
	// [V2EventPermissionRepliedData],
	// [V2EventPermissionV2AskedData],
	// [V2EventPermissionV2RepliedData],
	// [V2EventPluginAddedData],
	// [V2EventProjectDirectoriesUpdatedData],
	// [V2EventProjectUpdatedData],
	// [V2EventPtyCreatedData],
	// [V2EventPtyDeletedData],
	// [V2EventPtyExitedData],
	// [V2EventPtyUpdatedData],
	// [V2EventQuestionAskedData],
	// [V2EventQuestionRejectedData],
	// [V2EventQuestionRepliedData],
	// [V2EventQuestionV2AskedData],
	// [V2EventQuestionV2RejectedData],
	// [V2EventQuestionV2RepliedData],
	// [V2EventReferenceUpdatedData],
	// [V2EventServerConnectedData],
	// [V2EventSessionCompactedData],
	// [V2EventSessionCreatedData],
	// [V2EventSessionDeletedData],
	// [V2EventSessionDiffData],
	// [V2EventSessionErrorData],
	// [V2EventSessionIdleData],
	// [V2EventSessionNextAgentSwitchedData],
	// [V2EventSessionNextCompactionDeltaData],
	// [V2EventSessionNextCompactionEndedData],
	// [V2EventSessionNextCompactionStartedData],
	// [V2EventSessionNextContextUpdatedData],
	// [V2EventSessionNextModelSwitchedData],
	// [V2EventSessionNextMovedData],
	// [V2EventSessionNextPromptAdmittedData],
	// [V2EventSessionNextPromptedData],
	// [V2EventSessionNextReasoningDeltaData],
	// [V2EventSessionNextReasoningEndedData],
	// [V2EventSessionNextReasoningStartedData],
	// [V2EventSessionNextRetriedData],
	// [V2EventSessionNextRevertClearedData],
	// [V2EventSessionNextRevertCommittedData],
	// [V2EventSessionNextRevertStagedData],
	// [V2EventSessionNextShellEndedData],
	// [V2EventSessionNextShellStartedData],
	// [V2EventSessionNextStepEndedData],
	// [V2EventSessionNextStepFailedData],
	// [V2EventSessionNextStepStartedData],
	// [V2EventSessionNextSyntheticData],
	// [V2EventSessionNextTextDeltaData],
	// [V2EventSessionNextTextEndedData],
	// [V2EventSessionNextTextStartedData],
	// [V2EventSessionNextToolCalledData],
	// [V2EventSessionNextToolFailedData],
	// [V2EventSessionNextToolInputDeltaData],
	// [V2EventSessionNextToolInputEndedData],
	// [V2EventSessionNextToolInputStartedData],
	// [V2EventSessionNextToolProgressData],
	// [V2EventSessionNextToolSuccessData],
	// [V2EventSessionStatusData],
	// [V2EventSessionUpdatedData],
	// [V2EventTodoUpdatedData],
	// [V2EventTuiCommandExecuteData],
	// [V2EventTuiPromptAppendData],
	// [V2EventTuiSessionSelectData],
	// [V2EventTuiToastShowData],
	// [V2EventVcsBranchUpdatedData],
	// [V2EventWorkspaceFailedData],
	// [V2EventWorkspaceReadyData],
	// [V2EventWorkspaceStatusData],
	// [V2EventWorktreeFailedData],
	// [V2EventWorktreeReadyData].
	// The full corresponding event variant (id/type/durable/location/metadata) is
	// available via [V2Event.AsUnion].
