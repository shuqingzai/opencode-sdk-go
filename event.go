...
func (r EventListResponseType) IsKnown() bool {
	switch r {
	case EventListResponseTypeCommandExecuted, EventListResponseTypeFileEdited, EventListResponseTypeFileWatcherUpdated, EventListResponseTypeGlobalDisposed, EventListResponseTypeInstallationUpdateAvailable, EventListResponseTypeInstallationUpdated, EventListResponseTypeLspClientDiagnostics, EventListResponseTypeLspUpdated, EventListResponseTypeMcpBrowserOpenFailed, EventListResponseTypeMcpToolsChanged, EventListResponseTypeMessagePartDelta, EventListResponseTypeMessagePartRemoved, EventListResponseTypeMessagePartUpdated, EventListResponseTypeMessageRemoved, EventListResponseTypeMessageUpdated, EventListResponseTypePermissionAsked, EventListResponseTypePermissionReplied, EventListResponseTypeProjectUpdated, EventListResponseTypePtyCreated, EventListResponseTypePtyDeleted, EventListResponseTypePtyExited, EventListResponseTypePtyUpdated, EventListResponseTypeQuestionAsked, EventListResponseTypeQuestionRejected, EventListResponseTypeQuestionReplied, EventListResponseTypeServerConnected, EventListResponseTypeServerInstanceDisposed, EventListResponseTypeSessionCompacted, EventListResponseTypeSessionCreated, EventListResponseTypeSessionDeleted, EventListResponseTypeSessionDiff, EventListResponseTypeSessionError, EventListResponseTypeSessionIdle, EventListResponseTypeSessionNextAgentSwitched, EventListResponseTypeSessionNextCompactionDelta, EventListResponseTypeSessionNextCompactionEnded, EventListResponseTypeSessionNextCompactionStarted, EventListResponseTypeSessionNextModelSwitched, EventListResponseTypeSessionNextPrompted, EventListResponseTypeSessionNextReasoningDelta, EventListResponseTypeSessionNextReasoningEnded, EventListResponseTypeSessionNextReasoningStarted, EventListResponseTypeSessionNextRetried, EventListResponseTypeSessionNextShellEnded, EventListResponseTypeSessionNextShellStarted, EventListResponseTypeSessionNextStepEnded, EventListResponseTypeSessionNextStepFailed, EventListResponseTypeSessionNextStepStarted, EventListResponseTypeSessionNextSynthetic, EventListResponseTypeSessionNextTextDelta, EventListResponseTypeSessionNextTextEnded, EventListResponseTypeSessionNextTextStarted, EventListResponseTypeSessionNextToolCalled, EventListResponseTypeSessionNextToolFailed, EventListResponseTypeSessionNextToolInputDelta, EventListResponseTypeSessionNextToolInputEnded, EventListResponseTypeSessionNextToolInputStarted, EventListResponseTypeSessionNextToolProgress, EventListResponseTypeSessionNextToolSuccess, EventListResponseTypeSessionStatus, EventListResponseTypeSessionUpdated, EventListResponseTypeTodoUpdated, EventListResponseTypeCatalogModelUpdated, EventListResponseTypeTuiCommandExecute, EventListResponseTypeTuiPromptAppend, EventListResponseTypeTuiSessionSelect, EventListResponseTypeTuiToastShow, EventListResponseTypeVcsBranchUpdated, EventListResponseTypeWorkspaceFailed, EventListResponseTypeWorkspaceReady, EventListResponseTypeWorkspaceStatus, EventListResponseTypeWorktreeFailed, EventListResponseTypeWorktreeReady:
		return true
	}
	return false
}
