...
// InstanceService contains methods and other services that help with interacting with
// the opencode API.
//
...
// NewInstanceService generates a new service that applies the given options to each
...
// Dispose an instance
func (r *InstanceService) Dispose(ctx context.Context, query InstanceDisposeParams, opts ...option.RequestOption) (res *bool, err error) {
